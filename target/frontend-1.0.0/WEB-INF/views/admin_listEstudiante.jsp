        ...
        <div id="contenido">
            ...
            <div class="main-content">
                <div class="action-bar">
                    ...
                    <a href="http://localhost:3000/admin/estudiantes/nuevo" class="btn-nuevo">
                                ...
                                <c:otherwise>
                                    <c:forEach items="${estudiantes}" var="e">
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn-editar" href="http://localhost:3000/admin/estudiantes/${e.id}/editar">
                                                    <i class="fas fa-edit"></i> Editar
                                                </a>
                                                <form action="http://localhost:3000/admin/estudiantes/${e.id}/eliminar" method="post" style="display:inline">
                                                    <button type="submit" class="btn-eliminar" onclick="return confirm('�Est�s seguro de que deseas eliminar este estudiante?');">
