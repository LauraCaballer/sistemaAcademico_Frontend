...
<div id="contenido">
    ...
    <div class="main-content">
        <div class="action-bar">
            ...
            <a href="http://localhost:3000/admin/personas/nuevo" class="btn-nuevo">
                    ...
                    <c:otherwise>
                        <c:forEach items="${personas}" var="p">
                            <tr>
                                ...
                                <td>
                                    <a class="btn-editar" href="http://localhost:3000/admin/personas/${p.id}/editar">
                                        <i class="fas fa-edit"></i> Editar
                                    </a>
                                    <form action="http://localhost:3000/admin/personas/${p.id}/eliminar" method="post" style="display:inline">
